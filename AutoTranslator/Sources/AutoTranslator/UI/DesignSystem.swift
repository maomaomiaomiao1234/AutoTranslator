...
let WINDOW_MIN_HEIGHT: CGFloat = 464
...
let SOURCE_CARD_MIN_HEIGHT: CGFloat = 144
let SOURCE_CARD_CHROME_HEIGHT: CGFloat = 64
let SOURCE_TEXT_MIN_HEIGHT: CGFloat = 72
let SOURCE_TEXT_MAX_HEIGHT: CGFloat = SRC_MAX_CARD_HEIGHT - SOURCE_CARD_CHROME_HEIGHT
let DEST_CARD_MIN_HEIGHT: CGFloat = 164
